...
class Form extends Component {
  ...
  render() {
    const { key, titel, content } = this.props.dataEdit;
    return (
      <div className="container-fluid">
        <form >
          ...
          <div className="form-group">
            <label htmlFor=""></label>
            <input defaultValue={this.props} name="content" type="text" placeholder="Nội dung" onChange={(e) => this.getValueOnChange(e)} />
          </div>
